...
class Main: 
    """
    Esta es clase main no hace falta ponerla pero simplifica el uso de variables debajo se ponen como atributos los objetos que se van a usar 

    tienen None por que se definen mas adelante en el codigo 
    """
    ...
    def menu(self):
        """
        Esta funcion es menu principal del programa  donde vamos a elegir las opciones
        """
    ...
    def generar_digipymon_aleatorio(self):
            """
            Esta funcion genera un digipymon aleatorio añadiendole un nombre aleatorio
            y tambien se le añade id_contador para que se vaya sumando 1 cada vez que se llame a la funcion
            """
    ...
    def buscar_digipymon(self):
        """
        Esta funcion genera un digipymon aleatorio 
        y nos permite capturarlo con un  porcentaje segun el nivel 
        """
    ...
    def digishop(self ):
        """
        Esta funcion depliega un menu que nos permite comprar objetos 
        y los añade al inventario restando su precio 
        """
    ...
    def usar_item(self):
            """
            Esta funcion permite usar objetos sobre los digipymon aplicando sus bonificaciones
            y los resta del inventario si ya no quedan los elimina
            """
